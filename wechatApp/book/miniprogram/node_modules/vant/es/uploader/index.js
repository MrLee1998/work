...
import { ref, resolveDirective, mergeProps, createVNode } from "vue";
...
import { useLinkField } from '../composition/use-link-field'; // Components
  ...
  setup: function setup(props, _ref) {
    ...
    var previewImage = function previewImage(item) {
      if (props.previewFullImage) {
        ...
        imagePreview = ImagePreview(_objectSpread({
          images: images,
    ...
    var renderPreviewItem = function renderPreviewItem(item, index) {
      return createVNode(PreviewItem, mergeProps({
        "item": item,
        "index": index,
